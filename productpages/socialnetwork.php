...
$mysql = new mysqli('localhost', 'root', '', 'Kursovaya');
 $query = $mysql->query("SELECT * FROM `Описание` WHERE `id` = 2 ");
 $query1 = $mysql->query("SELECT * FROM `Мероприятие` WHERE `id` = 2 ");
            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-md-7 col-sm-6">
                    ...
                    <ul class="list-group list-group-horizontal-xl">
                      ...
                      <form method="post" action="socialnetworkdata.php">
                    ...
                    <ul class="list-group list-group-horizontal-sm">
                      ...
                      <form method="post" action="socialnetworkdata.php"><input type="hidden" name="seat" value="5" />
